    ...
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
      ...
      {loading ? (
        ...
        <div className="glass rounded-3xl p-12 text-center">
          ...
          <h3 className="text-xl font-bold mb-2">Aucun tournoi disponible</h3>
          <p className="text-slate-400">Reviens plus tard ou organise ton propre tournoi !</p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex flex-wrap items-center gap-3 text-sm text-slate-400">
                  ...
                  <span className="flex items-center gap-1"><Calendar size={14} className="text-amber-400" /> {new Date(t.startDate).toLocaleDateString('fr-TN', { day: 'numeric', month: 'short' })}</span>
                </div>
